...
namespace BloodDonationManagement.Migrations
{
    ...
    [Migration("20230702084351_AddedBloodBankAppUserPropertyToDonor")]
    partial class AddedBloodBankAppUserPropertyToDonor
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BloodDonationManagement.Models.Donor", b =>
                {
                    ...
                    b.HasOne("BloodDonationManagement.Models.BloodBankAppUser", "BloodBankAppUser")
                        .WithMany("Donors")
                        .HasForeignKey("BloodBankAppUserId");

...
namespace BloodDonationManagement.Controllers
{
    public class ContactController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,RegisteredId,UserType,Subject,Message")] Contact contact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,RegisteredId,UserType,Subject,Message")] Contact contact)
        {
            if (id != contact.Id)
            {
                return NotFound();
